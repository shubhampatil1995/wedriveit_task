	...
	<div class="row">
		<div class="col-md-9">
			...
			<?php echo $this->Form->create("Recruitment",array('url'=>'/recruitment/add')); ?>
				<div class="col-md-6">
					<?php echo $this->Form->input('job_post', array('type' => 'text','label' => 'Job Post','class' => 'form-control','error' => array('attributes' => array('wrap' => 'div','class' => 'help-inline')))); ?>
					<?php echo $this->Form->error('job_post'); ?>
				</div>
				<div class="col-md-6">
					<?php echo $this->Form->input('req_exp', array('type' => 'text','label' => 'Required Experience','class' => 'form-control','error' => true)); ?>
					
				</div>
				<div class="col-md-6">
					<?php $emptypes=$this->Global->getEmployType();?>
					<?php echo $this->Form->input('emp_type', array('type' => 'select','options' => $emptypes, 'label' => 'Employment Type','class' => 'form-control','error' => true)); ?>
				</div>
				<div class="col-md-6">
					<?php echo $this->Form->input('ctc_pa', array('type' => 'text','label' => 'CTC Per Annum','class' => 'form-control','error' => true)); ?>
				</div>
				<div class="col-md-6">
